...
function Home(){
  ...
  ,
      ...
      const handleSearch = () => {
        setShowResults(true); // Mostrar resultados quando clicar em Pesquisar
        setSearched(true); // Indicar que foi feita uma pesquisa
      };
        ...
        <div className="home">
            ...
            <div className="container ">
                    ...
                    <div className="inputDiv ">
                        ...
                        <button onClick={handleSearch} className="btnp">
                         Pesquisar
                        </button>
                    </div>
                 </div>
            ...
            <div  className="containerDiv">
                ...
                <div className="campoBoxDiv">
                    <div className="campoBox">
                        <div className="box">
                            <Link to='/Diretorias'>
                                <p className="item">Diretorias</p>
                            </Link>
                        </div>
                        <div className="box">
                            <Link to='/Desembargadores'>
                                <p>Desembargadores</p>
                            </Link>
                        </div>
                        <div className="box">
                            <Link to='/CorregedoriaGeralDeJustica'>
                                <p>Corregedoria-Geral de Justiça</p>
                            </Link>
                        </div>
                        <div className="box">
                            <Link to='/EscolaSuperiorDaMagistraturaTocantinense'>
                                <p>Escola Superior da Magistratura Tocantinense</p>
                            </Link>
                        </div>
                        <div className="box">
                            <Link to='/Foruns'>
                        ...
                        <div className="box">
                            <Link to='/TribunalDeJusticaTocantins'>
                                <p>Tribunal de Justiça do Estado do Tocantins</p>
                            </Link>
                        </div>
                    </div>
                </div>
